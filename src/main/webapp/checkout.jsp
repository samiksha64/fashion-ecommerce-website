...
<%
ResultSet rs = (ResultSet) request.getAttribute("checkoutData");
double subtotal = 0;
double shipping = 10;
%>
		...
		<div class="row">
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							<label class="form-label">Zip Code <span
								class="text-danger">*</span></label> <input type="text" name="zip"
			...
			<div class="col-lg-4">
				...
				<div class="card checkout-card p-3">
					...
					<button type="submit" formaction="PaymentServlet" class="btn checkout-btn w-100 mt-3">Continue to
						Payment</button>
