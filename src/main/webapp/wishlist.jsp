<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="java.util.*,com.pojo.Product,com.pojo.User"%>
...
<body>
	...
	<div class="wishlist-header text-center">
		...
		<nav class="d-flex justify-content-center">
			<ol class="breadcrumb mb-0">
				<li class="breadcrumb-item"><a href="ProductsIndexServlet">Home</a></li>
	...
	<div class="container mt-5 mb-5">
			...
			<table class="table align-middle text-center">
				...
				<tbody>
					...
					<tr>
						...
						<!-- Remove -->
						<td><a
							href="RemoveFromWishlistServlet?productId=<%=p.getId()%>"
							class="text-dark"> <i class="bi bi-x-lg"></i>
						</a></td>

						<!-- Product -->
						<td class="text-start">
							<div class="d-flex align-items-center">
								<img src="images/Illustrations/<%=p.getImage()%>" width="80"
									class="me-3 rounded">

								<div>
									<strong><%=p.getName()%></strong><br> <small
										class="text-muted"> <%=p.getDescription()%>
									</small><br> <small class="text-muted"> Color: <%=p.getColor()%>
									</small>
								</div>
							</div>
						</td>
		...
		<div class="text-center">
			...
			<a href="shop" class="btn btn-dark mt-3">Continue Shopping</a>
		</div>
	...
	<!-------------------------- Add to wishlist and remove from wishlist pop up message ---------------->
