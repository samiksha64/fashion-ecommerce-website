		...
		<div class="row">
			...
			<div class="col-lg-8 table-responsive">
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							<td><a
								href="RemoveFromCartServlet?cartId=<%=rs.getInt("cart_id")%>">
									<i class="bi bi-x-lg"></i>
							</a></td>

							<td><img
								src="images/Illustrations/<%=rs.getString("image")%>" width="60"><br>
			...
			<div class="col-lg-4">
				...
				<div class="card p-3">
					...
					<p>
						Subtotal: ₹<%=grandTotal - shipping%></p>
					<p>
						Shipping: ₹<%=shipping%></p>
					...
					<a href="CheckoutServlet" class="btn btn-dark w-100 mt-3">
